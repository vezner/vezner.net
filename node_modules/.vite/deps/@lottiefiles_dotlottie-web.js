...
var T1 = new Uint8Array([
	...
	"w",
	"h"
], n2 = "0.33.0", r2 = "@lottiefiles/dotlottie-web", J2 = .75;
var G2 = (() => {
	...
	return function(n = {}) {
		...
		var y1, c2 = !1, q, E, r1, d1, x, L, h2, p2;
		function v2() {
			var e = y1.buffer;
		...
		var K = 0, u1 = null;
		function w1(e) {
			throw r.onAbort?.(e), e = "Aborted(" + e + ")", n1(e), c2 = !0, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), y(e), e;
		}
		...
		var R1 = (e) => {
			...
			for (a = ""; t < i;) {
				...
				if (o & 128) {
					var s = e[t++] & 63;
					if ((o & 224) == 192) a += String.fromCharCode((o & 31) << 6 | s);
					else {
						var l = e[t++] & 63;
		...
		var $1 = (e) => {
		...
		}, z1 = !1, S2 = () => {}, I2 = (e, t, i) => t === i ? e : i.Ca === void 0 ? null : (e = I2(e, t, i.Ca), e === null ? null : i.ab(e)), F2 = {}, h1 = [], W1 = () => {
			for (; h1.length;) {
				var e = h1.pop();
				e.ma.Ka = !1, e.delete();
			}
			...
			return t.count = { value: 1 }, f1(Object.create(e, { ma: {
				value: t,
				writable: !0
			} }));
		...
		function h3(e, t) {
			...
			if (i = B1(t.ma.ya, t.ma.za.xa, this.xa), this.Qa) {
				...
				switch (this.pb) {
					case 0:
						if (t.ma.Da === this) i = t.ma.Aa;
						else throw new w(`Cannot convert argument of type ${t.ma.Da ? t.ma.Da.name : t.ma.za.name} to parameter type ${this.name}`);
						break;
					case 1:
						i = t.ma.Aa;
						break;
					case 2:
						...
						break;
					default: throw new w("Unsupporting sharing policy");
				}
			}
			return i;
		}
		...
		var D2 = (e) => {
			...
			switch (t) {
				case 1: return i ? (a) => q[a] : (a) => E[a];
				case 2: return i ? (a) => r1[a >> 1] : (a) => d1[a >> 1];
				case 4: return i ? (a) => x[a >> 2] : (a) => L[a >> 2];
				default: throw new TypeError(`invalid integer width (${t}): ${e}`);
			}
			...
			w1("initRandomDevice");
		}, z2 = (e) => (z2 = x3())(e), S1 = (e) => e % 4 === 0 && (e % 100 !== 0 || e % 400 === 0), W2 = [
			31,
			29,
			31,
			30,
		...
		var A3 = (e, t, i, a) => {
			...
			function u(d) {
				switch (d.getDay()) {
					case 0: return new Date(d.getFullYear() - 1, 11, 29);
					case 1: return d;
					case 2: return new Date(d.getFullYear(), 0, 3);
					case 3: return new Date(d.getFullYear(), 0, 2);
					case 4: return new Date(d.getFullYear(), 0, 1);
					case 5: return new Date(d.getFullYear() - 1, 11, 31);
					case 6: return new Date(d.getFullYear() - 1, 11, 30);
				}
			}
			function p(d) {
				var _ = d.Ia;
				for (d = new Date(new Date(d.Ja + 1900, 0, 1).getTime()); 0 < _;) {
					...
					if (_ > S - d.getDate()) _ -= S - d.getDate() + 1, d.setDate(1), 11 > g ? d.setMonth(g + 1) : (d.setMonth(0), d.setFullYear(d.getFullYear() + 1));
					else {
...
`,
				...
				"%V": (d) => {
					...
					if (2 >= (d.Ga + 371 - d.Ia - 2) % 7 && _++, _) _ == 53 && (g = (d.Ga + 371 - d.Ia) % 7, g == 4 || g == 3 && S1(d.Ja) || (_ = 1));
					else {
						_ = 52;
		...
		P2 = B2, w = r.BindingError = class extends Error {
			...
			clone: function() {
				...
				return e = e(i.call(t, a, { ma: { value: {
					count: o.count,
					Ka: o.Ka,
					Ma: o.Ma,
					ya: o.ya,
			...
			fromWireType: function(e) {
				...
				var a = d3(this.xa, i);
				if (a !== void 0) return a.ma.count.value === 0 ? (a.ma.ya = i, a.ma.Aa = e, a.clone()) : (a = a.clone(), this.Xa(e), a);
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
		...
		var k3 = {
			c: (e, t, i, a) => {
				w1(`Assertion failed: ${e ? X(E, e) : ""}, at: ` + [
					t ? t ? X(E, t) : "" : "unknown filename",
					i,
					a ? a ? X(E, a) : "" : "unknown function"
				]);
			},
			m: (e, t, i) => {
				var a = new a3(e);
				throw L[a.ya + 16 >> 2] = 0, L[a.ya + 4 >> 2] = t, L[a.ya + 8 >> 2] = i, C2 = e, C2;
			},
			B: function() {
				return 0;
			},
			...
			r: (e, t, i, a, o, s, l, u, p, h, v, b, M) => {
				...
				U1(d, function() {
					...
					return g = new _1(v, D, !0, !1, !1), g1 = new _1(v + "*", D, !1, !1, !1), S = new _1(v + " const*", D, !1, !0, !1), F2[e] = {
						pointerType: g1,
						$a: S
					}, T2(d, _), [
						g,
			...
			ca: (e, t, i, a, o, s, l, u, p, h, v, b) => {
				i = F(i), s = T(o, s), u = T(l, u), h = T(p, h), b = T(v, b), J([e], [t], (M) => (M = M[0], [new _1(i, M.xa, !1, !1, !0, M, a, s, u, h, b)]));
			},
			D: (e, t) => {
				t = F(t);
				var i = t === "std::string";
				W(e, {
					...
					fromWireType: function(a) {
						...
						if (i) for (var l = s, u = 0; u <= o; ++u) {
							var p = s + u;
							if (u == o || E[p] == 0) {
								if (l = l ? X(E, l, p - l) : "", h === void 0) var h = l;
								else h += "\0", h += l;
								l = p + 1;
							}
						}
			...
			u: (e, t, i) => {
				if (i = F(i), t === 2) var a = w3, o = b3, s = M3, l = (u) => d1[u >> 1];
				else t === 4 && (a = C3, o = L3, s = E3, l = (u) => L[u >> 2]);
				W(e, {
					name: i,
					fromWireType: (u) => {
	...
	static async _loadWithBackup() {
		return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (n) => {
			...
			try {
				...
				throw console.error(`Primary WASM URL failed: ${n.message}`), console.error(`Backup WASM URL failed: ${c.message}`), /* @__PURE__ */ new Error("WASM loading failed from all sources.");
			}
		})), this._ModulePromise;
	}
	static async load() {
...
var o2 = (f, n) => f === "reverse" ? n.Mode.Reverse : f === "bounce" ? n.Mode.Bounce : f === "reverse-bounce" ? n.Mode.ReverseBounce : n.Mode.Forward, s2 = (f, n) => f === "contain" ? n.Fit.Contain : f === "cover" ? n.Fit.Cover : f === "fill" ? n.Fit.Fill : f === "fit-height" ? n.Fit.FitHeight : f === "fit-width" ? n.Fit.FitWidth : n.Fit.None, d2 = (f, n) => {
	...
	constructor(n) {
		...
		this._canvas = n.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new o1(), this._frameManager = new x1(), this._renderConfig = {
			...n.renderConfig,
			...
			}), this._eventManager.dispatch({ type: "ready" }), n.data ? this._loadFromData(n.data) : n.src && this._loadFromSrc(n.src), n.backgroundColor && this.setBackgroundColor(n.backgroundColor);
		}).catch((r) => {
			this._eventManager.dispatch({
				type: "loadError",
				error: /* @__PURE__ */ new Error(`Failed to load wasm module: ${r}`)
			});
	...
	_loadFromData(n) {
		...
		y ? (this._eventManager.dispatch({ type: "load" }), I && this.resize(), this._eventManager.dispatch({
			type: "frame",
	...
	get layout() {
		...
		if (n) return {
			...
			fit: (() => {
				switch (n.fit) {
					case C._wasmModule?.Fit.Contain: return "contain";
					case C._wasmModule?.Fit.Cover: return "cover";
					case C._wasmModule?.Fit.Fill: return "fill";
					case C._wasmModule?.Fit.FitHeight: return "fit-height";
					case C._wasmModule?.Fit.FitWidth: return "fit-width";
					case C._wasmModule?.Fit.None: return "none";
	...
	_render() {
		...
		if (this._dotLottieCore.render()) {
			...
			return typeof ImageData > "u" ? (y = this._context.createImageData(this._canvas.width, this._canvas.height), y.data.set(c)) : y = new ImageData(c, this._canvas.width, this._canvas.height), this._context.putImageData(y, 0, 0), this._eventManager.dispatch({
				type: "render",
				currentFrame: this._dotLottieCore.currentFrame()
			}), !0;
		}
	...
	setRenderConfig(n) {
		...
		}, I && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? k.observe(this._canvas, this) : k.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? A.observe(this._canvas, this) : (A.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
	}
	loadAnimation(n) {
		if (this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === n) return;
		this._dotLottieCore.loadAnimation(n, this._canvas.width, this._canvas.height) ? (this._eventManager.dispatch({ type: "load" }), this.resize()) : this._eventManager.dispatch({
			type: "loadError",
			error: /* @__PURE__ */ new Error(`Failed to animation :${n}`)
		});
	}
	setMarker(n) {
		this._dotLottieCore !== null && this._dotLottieCore.setConfig({
	...
	_getPointerPosition(n) {
		let r = this._canvas.getBoundingClientRect(), c = this._canvas.width / r.width, y = this._canvas.height / r.height, R = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1;
		return {
			x: (n.clientX - r.left) * c / R,
			y: (n.clientY - r.top) * y / R
		};
	}
	_onPointerUp(n) {
	...
	animationSize() {
		return {
			width: this._dotLottieCore?.animationSize().get(0) ?? 0,
			height: this._dotLottieCore?.animationSize().get(1) ?? 0
		};
	}
...
var l2 = class {
	constructor() {
		...
		let n = new Blob([new Uint8Array([
			...
			59,
			10
		])], { type: "application/javascript" }), r = URL.createObjectURL(n), c = new Worker(r);
...
var N = class N {
	constructor(n) {
		...
		this._worker = N._workerManager.getWorker(r), N._workerManager.assignAnimationToWorker(this._id, r), N._wasmUrl && this._sendMessage("setWasmUrl", { url: N._wasmUrl }), this._create({
			...n,
			renderConfig: {
				...n.renderConfig,
				devicePixelRatio: n.renderConfig?.devicePixelRatio || e1(),
	...
	async destroy() {
		this._created && (this._created = !1, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), N._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), I && this._canvas instanceof HTMLCanvasElement && (A.unobserve(this._canvas), k.unobserve(this._canvas)));
	}
	async freeze() {
	...
	async _sendMessage(n, r, c) {
		...
		return this._worker.postMessage(y, c || []), new Promise((R, H) => {
			let $ = (z) => {
				let t1 = z.data;
				t1.id === y.id && (this._worker.removeEventListener("message", $), t1.error ? H(/* @__PURE__ */ new Error(`Failed to execute method ${n}: ${t1.error}`)) : R(t1.result));
			};
	...
	_getPointerPosition(n) {
		let r = this._canvas.getBoundingClientRect(), c = this._canvas.width / r.width, y = this._canvas.height / r.height, R = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1;
		return {
			x: (n.clientX - r.left) * c / R,
			y: (n.clientY - r.top) * y / R
		};
