import { FieldValues, SubmissionSuccess, SubmissionError, Client } from '@formspree/core';
...
declare const DataAttributes: {
     ...
     * ```
     */
    readonly SUCCESS: "data-fs-success";
    /**
     ...
     * ```
     */
    readonly SUBMIT_BTN: "data-fs-submit-btn";
    /**
...
interface FormConfig<T extends FieldValues = FieldValues> {
     ...
     */
    renderFieldErrors?: (context: FormContext<T>, error: SubmissionError<T> | null) => void;
    /**
...
declare const initForm: <T extends FieldValues = FieldValues>(config: FormConfig<T>) => FormHandle;

export { DataAttributes, ExtraData, FormConfig, FormContext, FormElement, FormHandle, initForm };
